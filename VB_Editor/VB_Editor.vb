...
Module VB_EditorMain
    ...
    Private Function insertLine(line As String) As Boolean
        ...
        If insideRunFunction Then
            Console.WriteLine(vbTab + vbTab + "If ocvb.intermediateReview = caller Then ocvb.intermediateObject = Me")
            changeLines += 1
            ...
            For Each filename In changeFiles
                ...
                For i = 0 To lines.Count - 1
                    If insertLine(lines(i)) Then
                        sw.WriteLine(vbTab + vbTab + "If ocvb.intermediateReview = caller Then ocvb.intermediateObject = Me")
                    End If
