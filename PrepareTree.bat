...
"C:\Program Files\CMake\bin\Cmake.exe" -DWITH_OPENGL=ON -DBUILD_PERF_TESTS=0 -DBUILD_TESTS=0 -DBUILD_opencv_python_tests=0 -DOPENCV_EXTRA_MODULES_PATH=OpenCV/OpenCV_Contrib/Modules -DCMAKE_CONFIGURATION_TYPES=Debug;Release -S OpenCV -B OpenCV/Build
