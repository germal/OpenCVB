...
"C:\Program Files\CMake\bin\Cmake.exe" -DWITH_OPENGL=ON -DWITH_VTK=ON -DBUILD_EXAMPLES=ON -DCPU_DISPATCH=SSE4_1;SSE4_2;AVX;FP16 -DVTK_DIR=VTK/Build/ -DBUILD_PERF_TESTS=OFF -DBUILD_TESTS=OFF -DBUILD_opencv_python_tests=OFF -DOPENCV_EXTRA_MODULES_PATH=OpenCV/OpenCV_Contrib/Modules -DCMAKE_CONFIGURATION_TYPES=Debug;Release -S OpenCV -B OpenCV/Build
