...
"C:\Program Files\CMake\bin\Cmake.exe" -DBUILD_CSHARP_BINDINGS=1 -DBUILD_CV_EXAMPLES=1 -DCMAKE_CONFIGURATION_TYPES=Debug;Release -S librealsense -B librealsense/Build
