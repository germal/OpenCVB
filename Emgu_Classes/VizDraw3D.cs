...
{
    public class VizDraw3D
    {
        public Emgu.CV.Viz3d v;
        public void Run(string leftImage, string rightImage)
        {
            //MCvPoint3D32f[] _points;
            Mat _left = CvInvoke.Imread(leftImage, ImreadModes.Color);
            Mat _right = CvInvoke.Imread(rightImage, ImreadModes.Color);
            ...
            v = new Emgu.CV.Viz3d("Simple stereo reconstruction");
