...
Public Class SVM_Simple
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        For i = 0 To dataSize
            labels.Set(Of Int32)(i, 0, msRNG.Next(-1, 1))
            trainData.Set(Of Single)(i, 0, CSng(msRNG.Next(0, src.Width - 1)))
            trainData.Set(Of Single)(i, 1, CSng(msRNG.Next(0, src.Height - 1)))
        Next
