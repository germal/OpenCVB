...
Public Class MeanShift_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Demonstrate the use of mean shift algorithm.  Draw on the images to define an object to track.  Tracker Algorithm")
    End Sub
...
Public Class MeanShift_Depth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        label1 = "Draw anywhere to start mean shift tracking."
        setDescription(ocvb, "Use depth to start mean shift algorithm.  Tracker Algorithm")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class MeanShift_PyrFilter
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use PyrMeanShiftFiltering to segment an image.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Meanshift_TopObjects
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        Next
        setDescription(ocvb, "Track - tracking algorithm")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        blob.src = src
        blob.Run(ocvb)
