...
Public Class Surf_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use left and right views to match points in horizontal slices.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Surf_DrawMatchManual_CS
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Compare 2 images to get a homography but draw the points manually in horizontal slices.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        surf.src = src
        surf.Run(ocvb)
