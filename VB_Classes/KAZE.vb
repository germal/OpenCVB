...
Public Class KAZE_KeypointsKAZE_CS
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Find keypoints using KAZE algorithm.")
...
Public Class KAZE_KeypointsAKAZE_CS
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Find keypoints using AKAZE algorithm.")
...
Public Class KAZE_Sample_CS
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Match keypoints in 2 photos.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class KAZE_Match_CS
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Match keypoints in the left and right images.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        red.Run(ocvb)
        dst1 = red.dst1
...
Public Class KAZE_LeftAligned_CS
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Match keypoints in the left and right images but display it as movement in the right image.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
