...
Public Class MatrixInverse_Basics_CS
    ...
    Public Sub Run(ocvb As AlgorithmData)
        If input.Width <> input.Height Then
            ocvb.putText(New oTrueType("The src matrix must be square!", 10, 60, RESULT1))
            Exit Sub
        End If
        ...
        ocvb.putText(New oTrueType(outstr + vbCrLf + "Intermediate results are optionally available in the console log.", 10, 60, RESULT1))
    End Sub
End Class
...
Public Class MatrixInverse_OpenCV
    ...
    Public Sub Run(ocvb As AlgorithmData)
        If Input.Width <> Input.Height Then
            ocvb.putText(New oTrueType("The input matrix must be square!", 10, 60, RESULT1))
            Exit Sub
        End If
        ...
        Dim outstr = printMatrixResults(input, result)
        ocvb.putText(New oTrueType(outstr, 10, 60, RESULT1))
    End Sub
End Class
