...
Public Class Edges_Canny
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.setupTrackBar2("Canny threshold2", 1, 255, 50)
        sliders.setupTrackBar3("Canny Aperture", 3, 7, 3)
...
Public Class Edges_Laplacian
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.setupTrackBar2("Laplacian Kernel", 1, 32, 5)
...
Public Class Edges_Preserving
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.setupTrackBar2("Edge Sigma_r", 1, 100, 40)
...
Public Class Edges_RandomForest_CPP
    ...
    Public Sub Run(ocvb As AlgorithmData)
        If ocvb.parms.testAllRunning Then
            ocvb.putText(New oTrueType("When 'Test All' is running, the database load can take longer than the test time" + vbCrLf +
                                                  "This test is not run during a 'Test All' run but runs fine otherwise.", 10, 100, RESULT2))
            Exit Sub
        End If
        If ocvb.frameCount < 10 Then
            ocvb.putText(New oTrueType("On the first call only, it takes a few seconds to load the randomForest model." + vbCrLf +
...
Public Class Edges_ResizeAdd
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.setupTrackBar2("Border Horizontal in Pixels", 1, 20, 5)
        sliders.setupTrackBar3("Threshold for Pixel Difference", 1, 50, 16)
...
Public Class Edges_DCTfrequency
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.setupTrackBar2("Threshold after Removal", 1, 255, 20)
...
Public Class Edges_Deriche_CPP
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.setupTrackBar2("Deriche Omega", 1, 1000, 100)
