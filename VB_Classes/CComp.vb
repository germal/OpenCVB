...
Public Class CComp_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Draw bounding boxes around RGB binarized connected Components")
        label1 = "CComp binary"
...
Public Class CComp_EdgeMask
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Isolate Color connected components after applying the Edge Mask")
...
Public Class CComp_ColorDepth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Color connected components based on their depth")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        If src.Channels = 3 Then src = src.CvtColor(cv.ColorConversionCodes.BGR2GRAY)
...
Public Class CComp_Image
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Connect components throughout the image")
...
Public Class CComp_InRange_MT
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Connected components in specific ranges")
...
Public Class CComp_InRange
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Connect components in specific ranges")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        If src.Channels = 3 Then src = src.CvtColor(cv.ColorConversionCodes.BGR2GRAY)
...
Public Class CComp_Shapes
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use connected components to isolate objects in image.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class CComp_OverlappingRectangles
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Define unique regions in the RGB image by eliminating overlapping rectangles.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        ccomp.src = src
        ccomp.Run(ocvb)
