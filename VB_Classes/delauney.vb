...
Public Class Delaunay_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Use Delaunay to subdivide an image into triangles.")
    End Sub
...
Public Class Delaunay_GoodFeatures
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use Delaunay with the points provided by GoodFeaturesToTrack.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        features.src = src
        features.Run(ocvb)
...
Public Class Delauney_Subdiv2D
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Generate random points and divide the image around those points.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Delauney_Coverage
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Combine random points with linear connections to neighbors to cover space. Note that space fills rapidly.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
