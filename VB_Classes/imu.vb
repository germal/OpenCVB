...
Public Class IMU_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Read and display the IMU coordinates")
    End Sub
...
Public Class IMU_Stabilizer
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Stabilize the image with the IMU data.")
...
Public Class IMU_Magnetometer
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Get the IMU_Magnetometer values from the IMU (if available)")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class IMU_Barometer
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Get the barometric pressure from the IMU (if available)")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class IMU_Temperature
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Get the temperature of the IMU (if available)")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        If ocvb.parms.IMU_Present Then
...
Public Class IMU_FrameTime
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use the IMU timestamp to estimate the delay from IMU capture to image capture.  Just an estimate!")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class IMU_HostFrameTimes
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        label2 = "IMU (blue) Host (green) Latency est. (red) - all in ms"
        setDescription(ocvb, "Use the Host timestamp to estimate the delay from image capture to host interrupt.  Just an estimate!")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class IMU_TotalDelay
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        label2 = "IMU (blue) Host (green) Latency est. (red) - all in ms"
        setDescription(ocvb, "Estimate time from IMU capture to host processing to allow predicting effect of camera motion.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        host.Run(ocvb)
        imu.Run(ocvb)
...
Public Class IMU_GVector
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        End If
        setDescription(ocvb, "Find the angle of tilt for the camera with respect to gravity.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class IMU_IsCameraLevel
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Answer the question: Is the camera level?")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        Dim gx = ocvb.parms.IMU_Acceleration.X
        Dim gy = ocvb.parms.IMU_Acceleration.Y
