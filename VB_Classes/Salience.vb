...
Public Class Salience_Basics_CPP
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Show results of Salience algorithm when using C++")
    End Sub
...
Public Class Salience_Basics_MT
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Show results of multi-threaded Salience algorithm when using C++.  NOTE: salience is relative.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        If src.Channels = 3 Then src = src.CvtColor(cv.ColorConversionCodes.BGR2GRAY)
