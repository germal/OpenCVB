...
Public Class DilateErode_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Dilate and Erode the RGB and Depth image.")
...
Public Class DilateErode_DepthSeed
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Erode depth to build a depth mask for inrange data.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class DilateErode_OpenClose
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Erode and dilate with MorphologyEx on the RGB and Depth image.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
