...
Public Class intrinsicsLeft_Basics
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        Next
        ocvb.putText(New TTtext(nextLine, 10, ttStart + 90))
        ...
        End If
        ocvb.putText(New TTtext(nextLine, 10, ttStart + 120))
        ...
        ocvb.putText(New TTtext(nextLine, ttLocation.X, ttLocation.Y, RESULT2))
