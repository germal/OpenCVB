...
Public Class intrinsicsLeft_Basics
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        Next
        ocvb.putText(New oTrueType(nextLine, 10, ttStart + 90))
        ...
        End If
        ocvb.putText(New oTrueType(nextLine, 10, ttStart + 120))
        ...
        ocvb.putText(New oTrueType(nextLine, ttLocation.X, ttLocation.Y, RESULT2))
