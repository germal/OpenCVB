...
Public Class Pencil_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Convert image to a pencil sketch - Painterly Effect")
    End Sub
...
Public Class Pencil_Manual
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Break down the process of converting an image to a sketch - Painterly Effect")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
