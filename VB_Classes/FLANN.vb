        ...
        Using nnIndex As New cv.Flann.Index(features, New cv.Flann.KDTreeIndexParams(4))
            ...
            For i = 0 To knnCount - 1
                ...
                For j = 0 To displayCount - 1
                    ...
                    cv.Cv2.Circle(dst, pt1, 5, cv.Scalar.Blue, -1, cv.LineTypes.AntiAlias, 0)
                    dst.Line(pt1, pt2, cv.Scalar.Red, 1, cv.LineTypes.AntiAlias)
                Next
                cv.Cv2.Circle(dst, pt2, 5, cv.Scalar.GreenYellow, -1, cv.LineTypes.AntiAlias, 0)
