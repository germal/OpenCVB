...
Public Class kMeans_BasicsDepthColor
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Cluster the rgb image pixels using kMeans.")
    End Sub
...
Public Class kMeans_Clusters
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Show clustering with various settings for cluster count.  Draw to select region of interest.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class kMeans_RGBFast
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        sliders.Setup(ocvb, caller)
        sliders.setupTrackBar(0, "kMeans k", 2, 32, 4)
        setDescription(ocvb, "Cluster a small rgb image using kMeans.  Specify clusterCount value.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class kMeans_RGB_Plus_XYDepth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Cluster with kMeans RGB, x, y, and depth.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        km.src = src
...
Public Class kMeans_XYDepth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Cluster with x, y, and depth using kMeans.  Draw on the image to select a region.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class kMeans_Depth_FG_BG
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Separate foreground and background using Kmeans (with k=2) using the depth value of center point.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        Dim columnVector As New cv.Mat
        Dim depth32f = getDepth32f(ocvb)
...
Public Class kMeans_LAB
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        Dim h = ocvb.color.Rows / 4
        ocvb.drawRect = New cv.Rect(w, h, w * 2, h * 2)
        setDescription(ocvb, "Cluster the LAB image using kMeans.  Is it better?  Optionally draw on the image and select k.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        Dim roi = ocvb.drawRect
...
Public Class kMeans_Color
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Cluster the rgb image using kMeans.  Color each cluster by average depth.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class kMeans_ColorDepth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Cluster the rgb+Depth using kMeans.  Color each cluster by average depth.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        Dim rgb32f As New cv.Mat
...
Public Class KMeans_Subdivision
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use KMeans to subdivide an image and then subdivide it again.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
