...
Public Class EigenVecVals_Basics
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        ocvb.putText(New oTrueType("Eigen Vals" + vbTab + "Eigen Vectors" + vbTab + vbTab + vbTab + vbTab + vbTab + "Original Matrix" + vbCrLf, 10, 25))
        ...
        For i = 0 To eigenVal.Rows - 1
            ...
            Next
            ocvb.putText(New oTrueType(nextLine, 10, 50 + i * 30))
        Next
        ...
        For i = 0 To eigenVec.Rows - 1
            ...
            Next
            nextLine += " = " + vbTab + "0.0"
            ocvb.putText(New oTrueType(nextLine, 10, 50 + i * 30, RESULT2))
        Next
    End Sub
End Class
