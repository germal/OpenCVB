...
Public Class Extrinsics_Basics
    ...
    Public Sub Run(ocvb As AlgorithmData)
        Dim ttStart = 40
        ocvb.putText(New TTtext("Rotation Matrix                                             Translation", 10, ttStart, RESULT1))
        Dim fmt = "#0.0000"
        ...
        ocvb.putText(New TTtext(nextLine, 10, ttStart + 20, RESULT1))
        ...
        ocvb.putText(New TTtext(nextLine, 10, ttStart + 40, RESULT1))
        ...
        ocvb.putText(New TTtext(nextLine, 10, ttStart + 60, RESULT1))
    End Sub
End Class
