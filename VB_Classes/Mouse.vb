...
Public Class Mouse_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Test the mousePoint interface")
    End Sub
...
Public Class Mouse_LeftClick
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Demonstrate what the left-click enables")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Mouse_RightClick
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Demonstrate what the right-click enables")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
