...
Public Class Reduction_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Reduction: a simple way to get KMeans with much less work")
    End Sub
...
Public Class Reduction_Edges
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "The simplest kmeans is to just reduce the resolution.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        kReduce.src = src
        kReduce.Run(ocvb)
...
Public Class Reduction_Floodfill
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        kReduce = New Reduction_Basics(ocvb)
        setDescription(ocvb, "Use the reduction KMeans with floodfill to get masks and centroids of large masses.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        kReduce.src = src
        kReduce.Run(ocvb)
...
Public Class Reduction_KNN
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use KNN with reduction to consistently identify regions and color them.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
