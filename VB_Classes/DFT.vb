...
Public Class DFT_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Explore the Discrete Fourier Transform.")
...
Public Class DFT_Inverse
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Take the inverse of the Discrete Fourier Transform.")
        label1 = "Image after Inverse DFT"
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class DFT_ButterworthFilter_MT
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use the Butterworth filter on a DFT image - color image input.")
...
Public Class DFT_ButterworthDepth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Use the Butterworth filter on a DFT image - RGBDepth as input.")
        label1 = "Image with Butterworth Low Pass Filter Applied"
        label2 = "Same filter with radius / 2"
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
