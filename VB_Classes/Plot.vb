...
Public Class Plot_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Plot data provided in src Mat")
    End Sub
...
Public Class Plot_Basics_CPP
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Demo the use of the integrated 2D plot available in OpenCV (only accessible in C++)")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Plot_OverTime
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Plot an input variable over time")
...
Public Class Plot_Histogram
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Plot histogram data with a stable scale at the left of the image.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        If standalone Then
...
Public Class Plot_Depth
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Show depth using OpenCV's plot format with variable bins.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        hist.Run(ocvb)
