...
Public Class TransformationMatrix_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        If ocvb.parms.cameraIndex = StereoLabsZED2 Then sliders.trackbar(0).Value = 1 ' need a smaller multiplier...
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        Else
            ocvb.putText(New TTtext("The transformation matrix for the current camera has not been set", 10, 125))
        End If
    End Sub
End Class
