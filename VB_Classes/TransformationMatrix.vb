...
Public Class TransformationMatrix_Basics
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        If ocvb.parms.transformationMatrix IsNot Nothing Then
            ...
            topLocations.Add(New cv.Point3d(-t(12) * mul + dst.Width / 2,
                                            -t(13) * mul + dst.Height / 2,
                                             t(14) * mul + dst.Height / 2))

            For i = 0 To topLocations.Count - 1
                Dim pt = topLocations.ElementAt(i)
                If pt.X > 0 And pt.X < dst.Width And pt.Z > 0 And pt.Z < ocvb.color.Height Then
                    dst.Circle(New cv.Point(pt.X, pt.Z), 3, cv.Scalar.Yellow, -1, cv.LineTypes.AntiAlias)
                End If

                If pt.Z > 0 And pt.Z < dst.Width And pt.Y > 0 And pt.Y < ocvb.color.Height Then
