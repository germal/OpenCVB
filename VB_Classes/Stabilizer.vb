...
Public Class Stabilizer_Basics
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        If ocvb.frameCount > 0 Then
            ...
            ocvb.putText(New TTtext(text, 10, 50, RESULT2))
            ...
            ocvb.putText(New TTtext(text, 10, 100, RESULT2))
...
Public Class Stabilizer_Basics_CPP
    ...
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        ocvb.putText(New TTtext("this algorithm is not stable.", 10, 100, RESULT1))
