...
import numpy as np
import argparse
title_window = 'Histogram_Bars.py'
...
histImage2 = cv.resize(histImage, (src.shape[0], src.shape[1]))
both = cv.hconcat([src, histImage2])
cv.imshow("Histogram and original image", both)
