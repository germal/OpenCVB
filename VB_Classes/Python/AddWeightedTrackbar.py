...
parser.add_argument('--input1', help='Path to the first input image.', default='PythonData/LinuxLogo.jpg')
parser.add_argument('--input2', help='Path to the second input image.', default='PythonData/WindowsLogo.jpg')
