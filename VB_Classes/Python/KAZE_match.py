...
parser.add_argument('--input1', help='Path to input image 1.', default='PythonData/graf1.png')
parser.add_argument('--input2', help='Path to input image 2.', default='PythonData/graf3.png')
parser.add_argument('--homography', help='Path to the homography matrix.', default='PythonData/H1to3p.xml')
