...
erc1 = cv.text.loadClassifierNM1(pathname+'/PythonData/trained_classifierNM1.xml')
er1 = cv.text.createERFilterNM1(erc1)

erc2 = cv.text.loadClassifierNM2(pathname+ '/PythonData/trained_classifierNM2.xml')
