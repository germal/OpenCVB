...
Public Class Filter_Laplacian
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Use a filter to approximate the Laplacian derivative.")
...
Public Class Filter_NormalizedKernel
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Create a normalized kernel and use it.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Filter_Normalized2D
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Create and apply a normalized kernel.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Filter_SepFilter2D
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Apply kernel X then kernel Y with OpenCV's SepFilter2D and compare to Gaussian blur")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
