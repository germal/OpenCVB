...
Public Class Vector_Magnitude
    ...
    Public Sub Run(ocvb As VBocvb)
        ...
        ocvb.trueText("euclidean_distance = " + CStr(euclidean_distance.Get(Of Single)(0, 0)))

        Dim manhattan_distance = cv.Cv2.Abs(diff_x) + cv.Cv2.Abs(diff_y)
        ocvb.trueText("manhattan_distance = " + CStr(manhattan_distance.ToMat.Get(Of Single)(0, 0)), 10, 90)
