...
Public Class Vector_Magnitude
    ...
    Public Sub New(ocvb As AlgorithmData)
        setCaller(ocvb)
        setDescription(ocvb, "Compute Euclidian and Manhattan Distance on a single vector.")
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        ocvb.trueText(New TTtext("euclidean_distance = " + CStr(euclidean_distance.Get(Of Single)(0, 0)), 10, 60))

        Dim manhattan_distance = cv.Cv2.Abs(diff_x) + cv.Cv2.Abs(diff_y)
        ocvb.trueText(New TTtext("manhattan_distance = " + CStr(manhattan_distance.ToMat.Get(Of Single)(0, 0)), 10, 90))
        ...
        ocvb.trueText(New TTtext("other_manhattan_distance = " + CStr(other_manhattan_distance.Get(Of Single)(0, 0)), 10, 120))
    End Sub
End Class
