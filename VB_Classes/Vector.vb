...
Public Class Vector_Magnitude
    ...
    Public Sub Run(ocvb As AlgorithmData)
        ...
        ocvb.putText(New oTrueType("Original vector = " + CStr(cVector(0)) + ", " + CStr(cVector(1)) + ", " + CStr(cVector(2)) + ", " + CStr(cVector(3)), 10, 30))
        ...
        ocvb.putText(New oTrueType("euclidean_distance = " + CStr(euclidean_distance.Get(Of Single)(0, 0)), 10, 60))

        Dim manhattan_distance = cv.Cv2.Abs(diff_x) + cv.Cv2.Abs(diff_y)
        ocvb.putText(New oTrueType("manhattan_distance = " + CStr(manhattan_distance.ToMat.Get(Of Single)(0, 0)), 10, 90))
        ...
        ocvb.putText(New oTrueType("other_manhattan_distance = " + CStr(other_manhattan_distance.Get(Of Single)(0, 0)), 10, 120))
    End Sub
End Class
