...
Public Class Math_Subtract
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Invert the image colors using subtract")
    End Sub
...
Public Class Math_Median_CDF
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Compute the src image median")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Math_DepthMeanStdev
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "This algorithm shows that just using the max depth at each pixel does not improve quality of measurement")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        minMax.src = src
        minMax.Run(ocvb)
...
Public Class Math_RGBCorrelation
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Compute the correlation coefficient of Red-Green and Red-Blue and Green-Blue")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        Dim split = src.Split()
