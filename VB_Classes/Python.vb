...
Public Class Python_Run
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        Else
            StartPython(ocvb, "")
        End If
        setDescription(ocvb, "Run Python app: " + pythonApp.Name)
        label1 = ""
        label2 = ""
    End Sub
...
Public Class Python_MemMap
    ...
    Public memMapbufferSize As Int32
        ...
        if standalone Then
            ...
            setDescription(ocvb, "Run Python app: " + pythonApp.Name + " to share memory with OpenCVB and Python.")
        End If
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
...
Public Class Python_SurfaceBlit
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Stream data to Python_SurfaceBlit Python script.")
    End Sub
    Public Sub Run(ocvb As AlgorithmData)
        If PythonReady Then
