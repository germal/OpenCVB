...
Public Class Grayscale_Basics
    ...
    Public Sub New(ocvb As AlgorithmData)
        ...
        setDescription(ocvb, "Manually create a grayscale image.  The only reason for this example is to show how slow it can be to do the work manually in VB.Net")
